...
import com.infy.dto.ResponseMessage;
...
public class ExceptionControllerAdvice {
	...
	public ResponseEntity<ResponseMessage> exceptionHandler2(Exception ex) 
 	{
	...
	public ResponseEntity<ResponseMessage> exceptionHandler2(NoSuchCustomerException ex) 
	{
		ResponseMessage error = new ResponseMessage();
	...
	public ResponseEntity<ResponseMessage> handleConstraintValidationExceptions(ConstraintViolationException ex) 
	{
		ResponseMessage error = new ResponseMessage();
	     error.setResponseCode(HttpStatus.BAD_REQUEST.value());
